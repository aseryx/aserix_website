        ...
        <div className="flex flex-col gap-8 p-4 sm:p-8 items-center w-full max-w-7xl">
          ...
          <div className="w-full">
            <div className="space-y-6">
              ...
              <h2 className='text-4xl sm:text-5xl font-bold text-[#f7861e] leading-[0.9] h-12 sm:h-16 relative overflow-hidden'>
                <span className="font-semibold">{rotatingWords[rotatingIndex]}</span>
              </h2>
            </div>
          </div>

          {/* Section 2: Video/Image Section */}
          <div className="relative w-full">
            <div className="bg-gradient-to-br from-[#fc5f2b] to-[#f7861e]-bg rounded-2xl shadow-2xl border border-gray-100 relative w-full overflow-hidden">
